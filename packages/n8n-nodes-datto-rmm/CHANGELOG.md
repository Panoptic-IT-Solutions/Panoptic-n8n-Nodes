...
- 265a00d: Add enhanced user login/logout detection and device online/offline tracking
...
- 2aa1f1d: Dramatically improve Activity Log historical data retrieval
...
- 77033fb: Replace activity log implementation with working device activity monitoring
...
- 05b45a6: Fix "Could not get parameter" error for Activity Log operations
